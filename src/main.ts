...
import deleteCliente from "./controllers/Cliente/deleteCliente";
import GeracaoDeCliente from "./controllers/Cliente/gerar"
import ListagemClientes from "./controllers/Cliente/listagemClientes";
//Produto
import CadastroProduto from "./controllers/Produto/cadastroProdutos";
import updateProduto from "./controllers/Produto/updateProduto";
import deleteProduto from "./controllers/Produto/deleteProduto";
import ListagemProduto from "./controllers/Produto/listagemProduto";
//Servços
import CadastroServico from "./controllers/Servico/cadastroServico";
import updateServico from "./controllers/Servico/updateServico";
import ListagemServico from "./controllers/Servico/listagemServico";
import deleteServico from "./controllers/Servico/deleteServico";
//Listagem
import ListagemGenero from "./controllers/Listagem/listagemGenero";
import ListagemMenosQuantidade from "./controllers/Listagem/listagemClienteMenosConsumidor"
import listagemClienteValor from "./controllers/Listagem/ListagemClienteValor"
import ListagemQuantidade from "./controllers/Listagem/ListagemClienteConsumidor";
import psGenero from "./controllers/Listagem/LMGenero"
import psConsumidos from "./controllers/Listagem/listagemPSConsumidos";
...
while (execucao) {
    ...
    console.log(`18 - Listar dos clientes que mais consumiram por valor`);
    console.log(`0 - Sair`);
